...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{componentView.png}
...
As mentioned previously, this component is primarily responsible for all operations related to system functionality. More specifically, this component is divided into seven sub-components, each related to a different kind of functionality and operation:
\begin{itemize}
